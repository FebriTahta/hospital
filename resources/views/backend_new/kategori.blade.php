                    ...
                    <div class="col-md-3">
                        <div class="counter-box white r-5 p-3">
                            <div class="p-4">
                                ...
                                <h5 class="sc-counter mt-3"> {{count($kategori)}} </h5>
                            </div>
                ...
                <form id="formdel" method="POST"> @csrf
                    ...
                    <div class="modal-body">
                        <div class="py-3 text-center">
                            ...
                            <p>Kategori ini akan hilang pada setiap posting yang ada apabila ada posting yang menggunakan kategori ini</p>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-secondary btn-sm" id="btndel" value="YA HAPUS">
                    </div>
                </form>
            </div>
        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 200) {
                        ...
                        // $('#errList').append('<div>' + response.errors + '</div>');
                    }
                },
                error: function(data) {
                    console.log(data);
