                                ...
                                <div class="row my-3">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judul_posting" id="judul" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi_posting" id="deskripsi" class="my-editor form-control" cols="30" rows="30"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
